...
import { Send, Mic, MicOff, AlertCircle, Loader2, Sparkles, Check, Square, ChevronDown, ChevronUp, ChevronRight, Pencil } from "lucide-react";
            ...
            <div className="flex flex-col gap-2">
              ...
              {showBackToInvest && i === 0 && msg.role === "ai" && (
                <button
                  ...
                  className="ml-7 mt-2 self-start flex items-center gap-3 rounded-xl border px-3.5 py-2.5 transition-colors hover:bg-muted/40"
                  style={{ borderColor: "hsl(220, 30%, 75%)", backgroundColor: "hsl(220, 30%, 97%)" }}
                >
                  <div className="flex flex-col">
                    <span className="text-[9px] font-medium text-muted-foreground">Ready to invest?</span>
                    <span className="text-[12px] font-semibold" style={{ color: "hsl(220, 40%, 25%)" }}>View your plan</span>
                  </div>
                  <ChevronRight className="h-3.5 w-3.5" style={{ color: "hsl(220, 30%, 55%)" }} />
                </button>
              )}
            </div>
          )}
