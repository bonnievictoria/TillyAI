...
const Profile = () => {
  ...
  return (
    <div className="mobile-container bg-background pb-20 min-h-screen">
      ...
      {/* Navigation rows */}
      {([
        { icon: FileText, title: "Investment Policy Statement", sub: "Investment guidelines", route: "/profile/ips" },
        { icon: User, title: "Complete Profile Wizard", sub: "Guided step-by-step profile setup", route: "/profile/complete" },
        { icon: MessageSquareText, title: "Meeting Notes", sub: "Review past meeting transcripts", route: "/meeting-notes" },
      ] as const).map((item) => (
